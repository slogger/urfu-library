...
| 169.254/16            |         | RFC 3927 | APIPA Automatically Private IP Adressing. Если мы соберем сеть, не конфигурируя ее, она будет работать с IP адресами из этого диапазона.
...
| fc00::/7              |         | RFC 4193 | "Частный" диапозон, применяется внутри компаний
